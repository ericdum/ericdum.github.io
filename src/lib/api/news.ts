...
const news: NewsItem[] = [
  ...
  },
  {
    ...
    thumbnail: "https://res.dreamhangar.cn/images/news/9/1.jpg",
    fullContent: `
      <div class="article-content">
        ...
        <img src="https://res.dreamhangar.cn/images/news/9/1.jpg" alt="讲座现场" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/9/2.jpg" alt="讲座现场" class="object-cover rounded-lg w-full h-full my-8">
