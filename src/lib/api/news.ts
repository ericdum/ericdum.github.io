...
const news: NewsItem[] = [
  {
    ...
    thumbnail: "https://res.dreamhangar.cn/images/news/5/thumb.jpg",
    fullContent: `
  ...
  },
  {
    ...
    thumbnail: "https://res.dreamhangar.cn/images/news/4/cover.png",
    fullContent: `
      <div class="article-content">
  ...
  },
  {
    ...
    thumbnail: "https://res.dreamhangar.cn/images/news/10/cover.jpeg",
    fullContent: `
      <div class="article-content">
        <p>大家好，我是莎莫。</p>
        ...
        <img src="https://res.dreamhangar.cn/images/news/10/cover.jpeg" alt="云谷学校" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/10/design.gif" alt="设计作品" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/10/design_week.jpeg" alt="设计周分享" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/10/factory1.jpeg" alt="工厂参观1" class="object-cover rounded-lg w-full h-full my-8">
        <p>去智能化工厂深度研学↓</p>
        <img src="https://res.dreamhangar.cn/images/news/10/factory2.jpeg" alt="工厂参观2" class="object-cover rounded-lg w-full h-full my-8">
        <p>与隔壁的西湖大学和阿里达摩院研讨↓</p>
        <img src="https://res.dreamhangar.cn/images/news/10/factory3.jpeg" alt="工厂参观3" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/10/ability_gap.jpeg" alt="能力鸿沟" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/10/susan.jpeg" alt="Susan老师" class="object-cover rounded-lg w-full h-full my-8">
        <p>■Susan老师</p>
        <p>说个简单的故事，可能你就理解了。</p>
        ...
        <img src="https://res.dreamhangar.cn/images/news/10/cambridge.jpeg" alt="剑桥大学招生官来访" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <p>下滑查看云谷学生的专业录取 👇</p>
        <p>每个人都找到自己的心之所向。</p>
        <img src="https://res.dreamhangar.cn/images/news/10/students1.jpeg" alt="学生录取1" class="object-cover rounded-lg w-full h-full my-8">
        <img src="https://res.dreamhangar.cn/images/news/10/students2.jpeg" alt="学生录取2" class="object-cover rounded-lg w-full h-full my-8">
        <img src="https://res.dreamhangar.cn/images/news/10/students3.jpeg" alt="学生录取3" class="object-cover rounded-lg w-full h-full my-8">
        <img src="https://res.dreamhangar.cn/images/news/10/students4.jpeg" alt="学生录取4" class="object-cover rounded-lg w-full h-full my-8">
        <p>这不是随便说说，而是被检验过的。</p>
        ...
        <img src="https://res.dreamhangar.cn/images/news/10/interns.jpeg" alt="回母校实习的孩子们" class="object-cover rounded-lg w-full h-full my-8">
        <p>■回母校实习的孩子们</p>
        ...
        <p>深度感受走在前沿不一样的教育</p>
        <p>去不了现场的也可以加老师咨询</p>
        <img src="https://res.dreamhangar.cn/images/news/10/qrcode1.jpeg" alt="二维码1" class="object-cover rounded-lg w-full h-full my-8">
        <img src="https://res.dreamhangar.cn/images/news/10/qrcode2.jpeg" alt="二维码2" class="object-cover rounded-lg w-full h-full my-8">
  ...
  },
  {
    ...
    thumbnail: "https://res.dreamhangar.cn/images/news/9/640.webp",
    fullContent: `
      <div class="article-content">
        <p>近日，杭州市卖鱼桥小学以"智启未来，AI赋能童年"为主题的第18届科技节圆满落幕。本届科技节以科技之光献礼百年华诞，展现了百年老校在新时代的创新活力。在为期两周的科技盛宴中，同学们在AI技术的赋能下，展开了一场别开生面的科技探索之旅。在空气炮、A4纸承重、胡萝卜搭高塔等项目中大显身手，用智慧与创新突破自我，创造了一个个令人惊叹的科技作品。</p>
        
        <h2>班级科创活动 创意玩科技</h2>
        
        <h3>一年级 乒乓球叠高</h3>
        <p>首先了解了乒乓球叠高的基本规则和技巧。随后，大家开始动手实践，利用A4纸和乒乓球进行创作。在规定的时间内，参与者们充分发挥想象力，有的小朋友利用"小道具"做成稳定立柱，有的将A4纸卷成纸筒以增加高度。大家相互学习、相互借鉴，现场气氛热烈而有序。</p>
        <p>通过本次活动，参与者们不仅成功搭建出了各种稳定且高度可观的乒乓球结构，还在实践中锻炼了自己的动手能力和团队协作能力。同时，大家也深刻体会到了"发现、探究、创造"的喜悦与科学的魅力。此外，活动还促进了参与者之间的交流与合作，增强了集体荣誉感。</p>
        
        <h3>二年级 纸飞机投远</h3>
        <p>二年级的纸飞机比赛正火热的进行中，小选手同场竞技，将科学课所学的空气动力学知识融入折叠技巧中。比赛现场，同学们化身"小小工程师"，反复调整机翼弧度、机身对称性与投掷角度。流线型机翼设计、不同纸飞机折法等创意频现。在操场上，同学们站在起点处激动的等待比赛的开始，一声令下，纸飞机被用力的投掷出去。本次活动不仅锻炼了动手能力，还在孩子的心中播下探索科学的种子，激发了对科学的热爱。</p>
        
        <h3>三年级 纸牌搭高塔</h3>
        <p>而在三年级的教室里，每班的"折纸大师"们严阵以待，小小的纸牌在他们手中变成了神奇的建筑材料。大家屏气敛息，小心翼翼地搭建心中的"高塔"。有的同学紧皱眉头思考结构，有的快速堆叠纸牌。每一张纸牌的摆放都至关重要，稍有不慎就可能前功尽弃。</p>
        <p>经过激烈角逐，一座座造型各异的纸牌高塔拔地而起，见证了同学们的心灵手巧。这次比赛不仅带来欢乐，更激发了大家对科学和创意的热爱，为科技节增添了一抹亮色！</p>
        
        <h3>四年级 不倒翁陀螺</h3>
        <p>四年级的同学们化身"科学小达人"，带来神奇的旋转不倒翁陀螺，带领大家一同开启奇妙的科学之旅。</p>
        <p>只见同学们利用身边极其常见的材料，勇敢地向平衡原理发起挑战。简单的四根长木棒、四根橡皮筋，再加上两个重物，竟创造出了能在指尖稳稳站立，甚至还能高速旋转的不倒翁陀螺。它的秘密究竟是什么？</p>
        <p>制作过程中，孩子们的思维活跃程度超乎想象，奇思妙想不断涌现。即便没有现成材料，也丝毫阻挡不了他们的探索热情。有的同学用竹签、筷子巧妙替代木棒；重物的选择更是五花八门，橡皮泥、黏土成为常见之选，苹果、梨、番薯、土豆等蔬果也"闪亮登场"，这些创意组合令人忍俊不禁，充分展现了同学们无穷的创造力。</p>
        
        <h3>五年级 A4纸承重</h3>
        <p>五年级的同学们迎来了一场别开生面的科技吉尼斯挑战赛——A4纸承重比赛，用最轻薄的纸张，挑战承重的极限，点亮科学的火花。</p>
        <p>同学们以小组为单位，利用4张A4纸，通过折叠、粘贴、搭建等步骤，构建出形态各异却坚实有力的承重结构。各小组充分发挥团队协作精神，有的负责设计结构，有的精心制作，还有的负责测试承重。当遇到技术难题时，小组成员们相互协助，共同寻找解决方案。当承重书本一点点增加，结构依然坚挺时，现场爆发出了阵阵欢呼。而当遇到挑战失利的情况，同学们也毫不气馁，迅速调整策略，重新投入到创作中。</p>
        <p>此次A4纸承重挑战赛，不仅锻炼了同学们的动手能力与创新思维，更在他们幼小的心灵中种下了科学探索的种子。这小小的纸结构，承载的不仅是重量，更是孩子们通往科技世界的大梦想。</p>
        
        <h3>六年级 萝卜搭高塔</h3>
        <p>六年级的"科技节吉尼斯挑战赛——萝卜高塔"正如火如荼地进行着。同学们化身小小工程师，用萝卜和牙签搭建着心中的"摩天大楼"。比赛现场，气氛紧张又热烈。每位同学都全神贯注，小心翼翼地搭建着自己的高塔。有的同学动作敏捷，迅速将萝卜块和牙签组合在一起；有的同学则沉着冷静，仔细测量每一层的高度，确保塔身稳固。高塔一次次倒塌，但孩子们毫不气馁，一次次重新开始，脸上洋溢着专注和自信。最终，经过激烈的角逐，608班的同学凭借155厘米193克重的萝卜高塔摘得桂冠。这次比赛不仅锻炼了同学们的动手能力和空间想象力，更让他们在实践中感受到了科技的魅力，体验到了创造的乐趣。</p>
        
        <h2>科普讲座进校园 多元知识点热情</h2>
        <p>这两周四场别开生面的活动带领同学们穿越时空、潜入深海、对话未来，在探索中感受科学魅力。</p>
        <p>浙江自然博物院的郑文杰老师带着他的精彩讲座《恐龙装甲 甲龙类恐龙的演化之道》来到了校园。郑老师以专业视角与生动讲解，系统梳理甲龙类恐龙从外形特征到演化脉络的完整历程，讲座现场气氛热烈非凡，同学们积极与郑老师互动交流，提出一个个充满好奇的问题，郑老师都耐心地予以解答。同学们仿佛推开了一扇通往远古生物世界的大门，领略到了大自然的神奇和伟大。</p>
        
        <p>爱田自然课堂带来的《探秘贝类王国》则引领四年级学生开启海洋生物之旅。柔思琪老师通过巴洛克珍珠、非洲大蜗牛等实物标本，结合生态保护案例，深入浅出地讲解贝类演化史与生态价值。特别设置的福寿螺与田螺对比观察，帮助同学们掌握外来物种鉴别方法，强化生态保护意识。</p>
        
        <p>爱田自然课堂为二年级学生带来《昆虫大家族》主题讲座，以甲虫的身体结构、蜜蜂的社会行为与蝴蝶的羽化奇迹为主线，展开沉浸式自然科学启蒙。讲座特别解密了"化蝶"的生命奇迹：通过图片呈现蝴蝶从卵、幼虫、蛹到成虫的完全变态发育过程。当屏幕上播放蝴蝶破茧过程影像时，孩子们屏息注视着蜷缩的翅膀在空气中缓缓舒展。活动现场老师与学生互动，用趣味的问题考察学生相关知识。</p>
        
        <p>特别关注的《拥抱 AI 时代》讲座中，杭州市科协代立晨老师通过趣味互动，揭开人工智能的神秘面纱。从大模型语言解析原理到 AI 写诗实践，从旅行规划应用到文化内涵探讨，同学们在 "人机对话" 中感受科技进步，现场生成的个性化 AI 旅行攻略成为热门话题。</p>
        
        <p>许多同学表示："原来科学探索这么有趣，我们也要像科学家一样思考！"，期待更多同学以好奇心为翼，在探索未知的道路上勇敢前行！</p>
        
        <h2>昆虫贝壳科技展 多维科普启智润心</h2>
        <p>本次科技节以"沉浸式科普体验"为特色，通过三大主题展览与科技互动区，为学生们打造自主探索的科学空间。</p>
        <p>阿里公益人培培老师和化石捐献人代表御风老师的慷慨捐献，为学校带来了一大批珍贵的古生物化石，其中那令人神往的恐龙蛋，以及来自各个地域的三叶虫化石、菊石化石等，瞬间吸引了师生的目光。在捐献仪式后，化石展示活动盛大开启，同学们围绕着这些化石，仔细端详，仿佛置身于远古的神秘世界，感受着岁月的沉淀和生命的奇迹。</p>
        
        <p>湖墅校区学生们在新开馆的昆虫微型博物馆学习观摩，领略自然科学魅力。文汇校区的贝壳博物馆则化身海洋生物课堂。两个博物馆内陈列着师生捐赠的珍贵标本100余件，学生们通过标本观察体验自然之美，了解生物的生存智慧。</p>
        
        <p>三、四年级同学走进校园"网红街区"，与科技互动，体验科技带来的生活小趣味。3D打印糖画借科技实现味蕾满足；借助手柄遥控小车竞速体验一把速度与激情；操控乐高机器人实现乒乓球投篮；与宾果机器人互动比拼人机方向反应力；体验过程中，学生从与科技互动开始，深入体验、思考如何更好的使用科技成果、如何借助科技成果完成生活中的实际任务，收获颇丰。</p>
        
        <p>科技节落下了帷幕，在为期两周的科技活动中，同学们凭借最简单的材料展开了大大的科学思考。让孩子们深刻体会到，科学并非遥不可及，而是实实在在地存在于日常生活的每一个角落。百年薪火相传，创新精神永续，这场科技盛宴不仅展现了新时代少年的创新风采，更彰显了学校百年办学历程中始终秉持的"创新育人"理念，为百年校庆增添了浓墨重彩的一笔。</p>
        
        <p><strong>来源：杭州市卖鱼桥小学</strong></p>
      </div>
    `
  },
  {
    ...
    thumbnail: "https://res.dreamhangar.cn/images/news/6/955.jpg",
    fullContent: `
      <div class="article-content">
        ...
        <img src="https://res.dreamhangar.cn/images/news/6/955.jpg" alt="新闻图片1" class="object-cover rounded-lg w-full h-full my-8">
        <p>在这个科技飞速发展的时代，教育的变革与创新从未如此紧迫。而AIGC（生成式人工智能）技术的崛起，就如同划破黑夜的一道曙光，为科学教育带来了前所未有的机遇与挑战。</p>
        <img src="https://res.dreamhangar.cn/images/news/6/958.jpg" alt="新闻图片2" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/6/960.jpg" alt="新闻图片3" class="object-cover rounded-lg w-full h-full my-8">
        <p>高校、中学、企业</p>
        ...
        <img src="https://res.dreamhangar.cn/images/news/6/962.jpg" alt="新闻图片4" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/6/965.jpg" alt="新闻图片5" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/6/967.jpg" alt="新闻图片6" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/6/969.jpg" alt="新闻图片7" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/6/970.jpg" alt="新闻图片8" class="object-cover rounded-lg w-full h-full my-8">
        <p>科学沙龙碰撞思维火花</p>
        <p>探寻AIGC+教育的多种可能性</p>
        ...
        <img src="https://res.dreamhangar.cn/images/news/6/971.jpg" alt="新闻图片9" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/6/975.jpg" alt="新闻图片10" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/6/977.jpg" alt="新闻图片11" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/6/978.jpg" alt="新闻图片12" class="object-cover rounded-lg w-full h-full my-8">
  ...
  },
  {
    ...
    thumbnail: "https://res.dreamhangar.cn/images/news/3/image-1.jpg",
    fullContent: `
      <div class="article-content">
        ...
        <img src="https://res.dreamhangar.cn/images/news/3/image-1.jpg" alt="新闻图片 1" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/3/image-2.jpg" alt="新闻图片 2" class="object-cover rounded-lg w-full h-full my-8">
        <p>曹林和代立晨，都是软件工程师。一个偶然的机会，他俩作为志愿者，通过线上授课的方式，给普安县铅矿学校的孩子们，上了两堂有关太空和航天知识的视频科普课，很受孩子们的欢迎。而课堂上孩子们的一个提问，让两个程序员动了心思。</p>
        <img src="https://res.dreamhangar.cn/images/news/3/image-3.jpg" alt="新闻图片 3" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/3/image-4.jpg" alt="新闻图片 4" class="object-cover rounded-lg w-full h-full my-8">
        <p>于是，曹林通过网上的火箭爱好者群或论坛，找到了还在深圳高校读书的火箭爱好者余畅一起加盟。三个小伙子通过网络沟通、分工，利用业余时间每天干到凌晨。十几天过后，终于拿出了一份很"亲近"小朋友的透明火箭设计方案。</p>
        <img src="https://res.dreamhangar.cn/images/news/3/image-5.jpg" alt="新闻图片 5" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/3/image-6.jpg" alt="新闻图片 6" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/3/image-7.jpg" alt="新闻图片 7" class="object-cover rounded-lg w-full h-full my-8">
        <p>最终，在铅矿学校校长、老师的帮助下，发射场地选在了大山深处一个闲置的养鸡场里，确保安全。紧接着，在一间简陋的民房里，小伙伴们就着一盆柴火、一张木桌，开始火箭组装。而伴随着组装工作进行的，也有大家不断的争论。</p>
        <img src="https://res.dreamhangar.cn/images/news/3/image-8.jpg" alt="新闻图片 8" class="object-cover rounded-lg w-full h-full my-8">
        <p>所有的争论，都是为了更好地接近目标。经过一昼夜努力，火箭组装完毕。第二天，为了给孩子们科普知识，找找发射火箭的感觉。大家带着四枚微型火箭来到学校，一边给孩子们讲课，一边让孩子们亲手发射火箭。</p>
        <img src="https://res.dreamhangar.cn/images/news/3/image-9.jpg" alt="新闻图片 9" class="object-cover rounded-lg w-full h-full my-8">
        <p>第三天，普安气象良好，大伙儿在发射场都很兴奋。泥巴水塘旁，空心砖一坐，曹林和余畅开始组装发射架。而由于前一天空气湿度大，放在露天的电动组装工具受潮罢工，大家只得手动拧螺栓，导致组装进度严重滞后。同时，曹林偏胖的身体也出现了状况。</p>
        <img src="https://res.dreamhangar.cn/images/news/3/image-10.jpg" alt="新闻图片 10" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/3/image-11.jpg" alt="新闻图片 11" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/3/image-12.jpg" alt="新闻图片 12" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/3/image-13.jpg" alt="新闻图片 13" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/3/image-14.jpg" alt="新闻图片 14" class="object-cover rounded-lg w-full h-full my-8">
    ...
    `,
    videoUrl: "https://res.dreamhangar.cn/images/news/3/video.mp4"
  },
  {
    id: 5,
    title: {
  ...
  },
  {
    ...
    author: "阿里巴巴公益",
    sourceUrl: "https://mp.weixin.qq.com/s?__biz=MzU2MzAxODI0Nw==&mid=2247567386&idx=1&sn=3ae23b2581765efcf8e3fc3f87933310",
    thumbnail: "https://res.dreamhangar.cn/images/news/7/bracelet.png",
    fullContent: `
      <div class="article-content">
        <p>国务院在2017年公布的《\"十三五\"国家老龄事业发展和养老体系建设规划》中指出：\"预计到2020年（也就是明年），全国60岁以上老年人口将增加到2.55亿人左右，独居和空巢老年人将增加到1.18亿人左右。\"</p>
        <img src="https://res.dreamhangar.cn/images/news/7/cover.png" alt="新闻图片1" class="object-cover rounded-lg w-full h-full my-8">
        <p>在这样的形势下，远在异乡的儿女们，如何照顾家里的老人成为了一个逃不开的话题。</p>
        <p>你们还记得去年那个为视障人士爆改一间房的代立晨（木酱）吗？</p>
        <img src="https://res.dreamhangar.cn/images/news/7/previous_project.png" alt="新闻图片2" class="object-cover rounded-lg w-full h-full my-8">
        <p>今年他又出来搞事情了，这次他的目标是老年人。</p>
        <img src="https://res.dreamhangar.cn/images/news/7/new_project.png" alt="新闻图片3" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/7/grandparents.png" alt="新闻图片4" class="object-cover rounded-lg w-full h-full my-8">
        <p>爷爷年轻的时候参与了南京长江大桥的建设。</p>
        <p>像那个年代走过来的很多人一样，爷爷几乎将一生都献给了祖国的桥梁事业，一年也回不了几次家。</p>
        <img src="https://res.dreamhangar.cn/images/news/7/bridge.png" alt="新闻图片5" class="object-cover rounded-lg w-full h-full my-8">
        <p>奶奶就坚持三四天给爷爷写一封信，这一写就是17年，2000多封信。</p>
        <p>终于等到了爷爷退休，突如其来的疾病却夺走了他的记忆。</p>
        <p>在这儿孙满堂之时，爷爷却叫不出他们的名字。</p>
        <img src="https://res.dreamhangar.cn/images/news/7/letters.png" alt="新闻图片6" class="object-cover rounded-lg w-full h-full my-8">
        <p>全球每3秒钟，就有1个人患上阿尔兹海默症，这种疾病最残忍的是——不可逆转。</p>
        <p>从爷爷患病以后，奶奶坚持亲自护理，寸步不离。</p>
        <p>因为一旦离开，爷爷就有可能走丢。</p>
        <p>有一次爷爷自顾自地推门出去，家人找了8个小时才把他找回来，问他为什么出去。他说\"我要找我老婆，曹雪梅\"。</p>
        <img src="https://res.dreamhangar.cn/images/news/7/care.png" alt="新闻图片7" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/7/sensors.png" alt="新闻图片8" class="object-cover rounded-lg w-full h-full my-8">
        <p>爷爷佩戴了一个手环，这个手环会监测爷爷的一些身体指数，再加上刚刚说的人体传感器给出的睡眠质量数据，睡觉和起床的时间等等， 系统会给一个综合的评分。如果今天给出的评分偏低了，那就要格外的关注一下爷爷的身体了。</p>
        <img src="https://res.dreamhangar.cn/images/news/7/bracelet.png" alt="新闻图片9" class="object-cover rounded-lg w-full h-full my-8">
        <p>手环更大的功能是可以实时检测爷爷的定位，如果爷爷以后再走丢可以通过地图定位找到他，还能一键呼叫爷爷，爷爷也可以一键报警。</p>
        <img src="https://res.dreamhangar.cn/images/news/7/location.png" alt="新闻图片10" class="object-cover rounded-lg w-full h-full my-8">
        <p>手机软件还中有爷爷家温度湿度的数据，孙女贝贝可以实时监测到老人家里的环境， 如果爷爷奶奶家温度过低， 也会预警到贝贝手机，还有开启空调的按钮，可以远程一键给他们开启空调。</p>
        <img src="https://res.dreamhangar.cn/images/news/7/temperature.png" alt="新闻图片11" class="object-cover rounded-lg w-full h-full my-8">
        <p>智能药箱是另一个惊喜，贝贝可以在系统里设置爷爷每天需要吃药的时间。比如爷爷每天晚上八点钟要吃药打针，八点十分，药箱还没有打开，那么贝贝手机端就会弹出一个提示，进入页面之后有个一键通话的功能，可以直接给奶奶打过去电话，提醒她给爷爷吃药。</p>
        <img src="https://res.dreamhangar.cn/images/news/7/medicine.png" alt="新闻图片12" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="https://res.dreamhangar.cn/images/news/7/fridge.png" alt="新闻图片13" class="object-cover rounded-lg w-full h-full my-8">
        <p>智能画框，是为爷爷量身定做的。因为爷爷的短期记忆的原因，儿女们可以把随时拍的视频和照片一键传运到爷爷奶奶的相框里，爷爷能每天都看到他们，或许就能够唤醒一些他的记忆。</p>
        <img src="https://res.dreamhangar.cn/images/news/7/frame.png" alt="新闻图片14" class="object-cover rounded-lg w-full h-full my-8">
        <p>奶奶的儿子在广州工作，只要对着说一声\"给儿子打电话\"，就会自动呼出视频电话。</p>
        <img src="https://res.dreamhangar.cn/images/news/7/video_call.png" alt="新闻图片15" class="object-cover rounded-lg w-full h-full my-8">
        <p>这样的设计不仅让不能守候在老人身边的儿女通过科技实时关注父母的健康状况。还能为社区和养老机构提供更高效的集中看护方案。</p>
        <img src="https://res.dreamhangar.cn/images/news/7/solution.png" alt="新闻图片16" class="object-cover rounded-lg w-full h-full my-8">
  ...
  },
  {
    ...
    author: "阿里云",
    sourceUrl: "https://mp.weixin.qq.com/s?__biz=MzU2MzAxODI0Nw==&mid=2247567386&idx=1&sn=3ae23b2581765efcf8e3fc3f87933310",
    thumbnail: "https://res.dreamhangar.cn/images/news/8/sensors.png",
    fullContent: `
      <div class="article-content">
        <p>房子如何既会听，又会看？</p>
        <p>最近央视《秘密大改造》播放了一期特殊节目：为一位视障人士进行家居改造。阿里云IoT工程师代立晨接受了这项极具挑战的项目。</p>
        <img src="https://res.dreamhangar.cn/images/news/8/cover.gif" alt="新闻图片1" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <p>灯带起到了为视障人士指路的作用。</p>
        <img src="https://res.dreamhangar.cn/images/news/8/light_guide.gif" alt="新闻图片2" class="object-cover rounded-lg w-full h-full my-8">
        <p>移步到客厅，不得不说说这个小编最喜欢的窗帘。只要当室外温度达到事先设置好的临界温度，窗帘就会自动合起，太阳下山前窗帘又会自动拉开。</p>
        <img src="https://res.dreamhangar.cn/images/news/8/curtain.gif" alt="新闻图片3" class="object-cover rounded-lg w-full h-full my-8">
        <p>洗手间的灯光也会根据主人的进出自动打开、熄灭。</p>
        <img src="https://res.dreamhangar.cn/images/news/8/bathroom_light.gif" alt="新闻图片4" class="object-cover rounded-lg w-full h-full my-8">
        <p>当主人走出洗手间，灯光会自动熄灭，马桶也会自动感应冲水。</p>
        <img src="https://res.dreamhangar.cn/images/news/8/toilet.gif" alt="新闻图片5" class="object-cover rounded-lg w-full h-full my-8">
        <p>不过你一定要问，这么多声控设备，万一自己的声音或者声控设备出了问题怎么办？</p>
        <p>这个问题，设计者早已经想好。房间内所有的电器都可以用包括物理按键、声音控制、手机APP控制三种方式去控制。</p>
        <img src="https://res.dreamhangar.cn/images/news/8/control.gif" alt="新闻图片6" class="object-cover rounded-lg w-full h-full my-8">
        <p>在60余平米的房子中，代立晨主要还是通过大量的传感设备、网络设置、传输指令实现对设备的统一控制。</p>
        <img src="https://res.dreamhangar.cn/images/news/8/sensors.png" alt="新闻图片7" class="object-cover rounded-lg w-full h-full my-8">
        <p>桌上摆着的一堆零件，有的是人体感应器，有的是红外信号发射器，有的是识别声音指令的，就是为了让家里的电器能够随时响应主人的需求。</p>
        <img src="https://res.dreamhangar.cn/images/news/8/parts.png" alt="新闻图片8" class="object-cover rounded-lg w-full h-full my-8">
