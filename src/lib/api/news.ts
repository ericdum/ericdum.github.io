...
const news: NewsItem[] = [
  {
    id: 11,
    title: {
      en: "How the School Founded by Jack Ma Is Harnessing AI",
      zh: "马云发起的学校，如何玩转AI"
    },
    content: {
      en: "China Philanthropist reports on how Hangzhou Yungu School integrates AI into authentic learning. The article highlights Lichen Dai's work guiding students to test OpenClaw in real service scenarios and develop the judgment, reasoning, and creativity that AI cannot replace.",
      zh: "《中国慈善家》报道杭州云谷学校如何将AI融入真实学习场景，重点记录了代立晨带领学生通过OpenClaw实践与真实接单，培养AI难以替代的判断、推理和创造能力。"
    },
    date: "2026-05-07",
    author: "中国慈善家·龚怡洁",
    sourceUrl: "https://www.zgcsj.com/zz/2026-05-07/2188.shtml",
    thumbnail: "https://res.mojalab.cn/images/news/11/01-cover.jpg",
    fullContent: `
      <div class="article-content">
      <figure class="my-8"><img src="https://res.mojalab.cn/images/news/11/01-cover.jpg" alt="新闻图片 1" class="object-cover rounded-lg w-full h-full">
      <figcaption class="mt-2 text-sm text-gray-500">2026年3月3日，阿里巴巴创始人马云在杭州云谷学校。</figcaption>
      </figure>
      <p>3月3日，春节后上班的第一天，马云现身杭州云谷学校。和他一起到来的，还有蔡崇信、吴泳铭等阿里和蚂蚁的一众围攻。</p>
      <p>由于发起人马云的愿望，云谷学校一直以来的关注。在成为阿里巴巴门人，马云曾是教师，在成功打造一个商业帝国之后，他在2017年的专辑中发表了云谷学校。这所学校，无疑寄托着他对教育的理解和期待。</p>
      <p>“‘教’和‘育’是两个概念。教，教授是知识；育，培养是文化……（中国的教育）‘教’非常好，‘育’一般，‘教’大于‘育’。中国成绩一般的学生，到欧美成绩最好的学生，却是竞争力最强的学生教师要通过发现、欣赏和引导，让孩子美好的内心激发，让孩子学习和探究的兴趣激发，让孩子无限的想象力和创造性激发，这些才能让孩子真正成为一个完整而幸福的人，而不是一个被动学习的机器。”马云曾这样表示。</p>
      <p>通过教育让孩子成为一个完整的人，是一个没有终点的课题。而在AI时代浪潮涌来后，教育又面临着新的挑战。2026年初，OpenClaw等AI应用给各行各业都带来了巨大的冲击，教育领域也不例外。从建校以来就带有强大科技基因的云谷学校，也在冲击波中进一步思考AI之于教育的意义。</p>
      <p>思考在马云3月3日在云谷的言论中可见一斑。“看一所学校不是属于AI时代的学校，不是看一所学校有多少AI服务器，有多强的AI技能。因为AI拥有了芯片，而人类拥有了心灵，AI时代对教育最大的改变，是老师们可以彻底做‘灵魂工程师’，而不是做知识的灌输者。”马云说。</p>
      <p>言下之意，对于这所背靠科技大厂的学校而言，技术固然重要，但技术只是辅助，所有的工具都需要服务于人。</p>
      <p>如今，AI给学生和老师带来了哪些新东西，如何服务于人，如何颠覆传统的教育模式？</p>
      <h2>同学们下场养龙虾</h2>
      <p>今年高二的邓睿涵，一直有一种强烈的感觉：AI不可靠！</p>
      <p>邓睿涵很喜欢计算机。2021年，他进入杭州云谷学校初读一，当时他向家里申请了第一批，完成了台属于自己的电脑。当时还没有AI，所以关于CPU和显卡之类的硬件应该怎么选，拼装和焊接的工程知识，都是他上网一点搜罗来的信息，理解、消化，自己再动手尝试。</p>
      <p>换到现在，邓睿涵如果要组建一台电脑，可以求助于AI，从硬件的选择指标和建议，到整个安装步骤，甚至还有注意事项、避坑指南，AI都会详细周到地给出答案。</p>
      <figure class="my-8"><img src="https://res.mojalab.cn/images/news/11/02-product-demo.jpg" alt="新闻图片 2" class="object-cover rounded-lg w-full h-full">
      <figcaption class="mt-2 text-sm text-gray-500">2025年云谷学校学术周产品发布会上，包恩熹讲解自己的小程序。</figcaption>
      </figure>
      <p>也就是说，有了AI之后，获取知识变得非常容易。云谷的老师和孩子们，喜欢把这种变化用“上山和下山”的比喻来形容：从以前的学习，是依靠已有的知识体系，一点点地爬上山去学，但有了AI之后，它马上就能把你送到山顶了。</p>
      <p>但“下山”的问题随之而来。AI给的答案，也许你已经完成了电脑，但其中做选择、做搭建的背后逻辑，如果没能了解透透，你就可以按照或者没有进行活学活用地进行完成和配置。另外，AI的判断不一定准确，有时候会撒谎。如果太轻易地相信它，可能也不能完成自己的目标。</p>
      <p>这也是邓睿涵觉得AI没那么靠谱的原因。所以，他选择对AI保持一定距离。有一年暑假，他学习了机器学习的课程，系统了解了人工智能大模型是如何被训练出来的。“那时候就感觉它的生成原理很不靠谱，太有随机性了。所以从那时候开始，我就对这个技术产生一些不信任感，我会很有限度地去使用它。”他告诉《中国慈善家》。</p>
      <p>那么，在学习当中应该怎样使用AI，要使用到什么程度，这是这所学校一直要考虑的问题。尤其是学校里的计算机CL班，他们正站在应对问题的最前沿。所谓的CL班，是指在上高二前，云谷学生们需要选择自己的主修课（在学校里称作CL课，指的是College Level，大学水平课程），其中也包含计算机原理——这正是邓睿涵所在的班级。</p>
      <p>负责带这个班的，是云谷的工程技术老师代立晨，他被学生们亲切地喊作“木酱”。代立晨留寸头、蓄胡子、戴圆框眼镜，他经常穿着SpaceX的T恤，说自己是特斯拉和SpaceX的小股东。在2023年来到云谷、成为一名老师之前，他在阿里工作了九年，曾经担任阿里云的智慧航空技术总监。</p>
      <p>2026年初，Clawdbot(OpenClaw的前身)爆火，代立晨随即在群里给学生布置作业：“寒假里，记得研究研究小龙虾。”</p>
      <figure class="my-8"><img src="https://res.mojalab.cn/images/news/11/03-robotics.jpg" alt="新闻图片 3" class="object-cover rounded-lg w-full h-full">
      <figcaption class="mt-2 text-sm text-gray-500">云谷小学部四至五年级机器人运动会上，孩子们在讨论方案。</figcaption>
      </figure>
      <p>“最早我在B站上刷到龙虾，抱着试一下玩一玩的心理，我把安装链接复制下来，结果报错了。”邓睿涵告诉《中国慈善家》。后来，他花了一个下午时间，弄明白自己的电脑里缺少哪些环境，最终驯服了这只龙虾。</p>
      <p>接着，代立晨有了另一个想法。他鼓励邓睿涵，去闲鱼挂链接，尝试给别人安装龙虾——那段时间，“代安装龙虾”一度成为副业的超级风口，腾讯深圳总部楼下曾开展过一次免费安装OpenClaw活动，足足吸引来近千人排队。“这可是你挣零花钱的好机会啊！”代立晨对自己的爱徒说，并且使出了为师的杀手锏：成功安装一单，就可以自选免掉一个作业。</p>
      <p>于是，邓睿涵接单了。头两个订单因为各种技术原因夭折了，直到第三单，他终于拿到甲方的25元报酬，减去投流的钱，净挣5块。</p>
      <p>聊起接单的过程，师生二人不约而同笑了起来。在这次实践当中，他们完成了一次宝贵的教学。“其实不是真的要求他们必须把龙虾用起来，因为它还存在很多问题。重要的是，要去体验龙虾到底‘能做到什么’。高中生的生活经验是很有限的，网上有些人说龙虾能做这做那，有很多吹嘘和虚构的成分。你到闲鱼里接单，就是一个真实的东西，会看到更多的场景，了解用户需要它做什么。” 代立晨说。</p>
      <p>后来，代立晨把邓睿涵“养龙虾”过程中的问题和方案，搬进了课堂。龙虾的云端养料“token”要花钱，邓睿涵想到了一个省钱的办法：借助他在学校里组装好的一台主机，运行他笔记本电脑里的龙虾。主机有两张显卡，性能较好，龙虾在本地也可以“游得动”，不必再花钱购买云端token。</p>
      <p>“如果你发现一个尚未解决的问题，没有既定答案，那很大概率AI也不能解决它。这个时候你的经验、知识、推理能力，你的创造力就非常重要，这是市场上稀缺的，也是AI难以替代的。”代立晨告诉记者，“现在课堂要教的，就是各种场景下发现问题、理解问题、解决问题的能力。要让学生尽可能地贴近世界，而不是处在高度抽象的真空实验里。”</p>
      <h2>老师下场手搓游戏</h2>
      <p>“拿出你们的iPad扫码玩个游戏吧！”初二的课堂上，听到语文老师王怡萱如此宣布，孩子们的眼睛一下子亮了。</p>
      <figure class="my-8"><img src="https://res.mojalab.cn/images/news/11/04-ai-game.png" alt="新闻图片 4" class="object-cover rounded-lg w-full h-full">
      <figcaption class="mt-2 text-sm text-gray-500">王怡萱老师用AI手搓的《昆虫记》RPG游戏。</figcaption>
      </figure>
      <p>电子游戏在许多父母眼里是“洪水猛兽”，也确实有许多孩子沉迷其间难以自拔。那么，作为一个“技术友好”的学校，是否有可能把游戏转为某种学习的工具？</p>
      <p>2025年，云谷教学平台上线了面对教师开放的“云谷AI”。这间学校诞生以来，就拥有一个伴生的研发中心——云谷教育科技。借助阿里等大厂的技术力量，公司负责为云谷搭建起一套自有的教务管理系统，一方面保证学校高校平稳地运转；另一方面也将其作为自己的产品，向外销售，让学校拥有一定的自我造血能力。</p>
      <p>云谷AI，是他们的最新尝试。它相当于“教育定制化”的AI，可以让老师自选DeepSeek、千问等大模型进行交流，让AI代替他们进行编程。这也是如今AI领域正流行的操作模式：氛围编程（Vibe Coding）。用户向AI描述自己的需求，AI则根据它写好代码，生产出一个直接可操作的应用。如果发现任何bug，仍然可以通过简单的自然语言交流，让AI对代码进行优化修改。即使是完全不懂编程的小白，通过氛围编程，也可以“搓”出自己心里构想的那款应用程序。</p>
      <p>王怡萱老师一直是个游戏迷，语文课堂上的游戏，就是她自己用AI做的。游戏是像素风格，角色扮演类型，《昆虫记》作者法布尔就是荒石园昆虫世界的引导NPC。通过与他的对话，玩家需要找到对应的昆虫，阅读昆虫的档案（文案内容即摘录自《昆虫记》），中间遇到过河之类的关卡，还需要自己寻找材料、合成小船去见对岸的昆虫。随着不断探索游戏地图，经历提出猜测、观察实验、得出结论、记录日志的过程，学生就可以读到这本名著里各式各样的昆虫故事，还能体会实用文所需的阅读策略。</p>
      <p>第一次玩这个游戏的时候，孩子们就非常兴奋，但没几分钟，就开始卡bug了。王怡萱把问题和孩子们的意见都收集上来，集中改bug，对游戏进行迭代。她甚至让学生自己尝试参与游戏世界观和内容的创作——方法也很简单，只要提炼改写自己读到的《昆虫记》内容，让AI把新的昆虫故事写入游戏代码的相应位置即可。这样一来，同学们既读了书，又跟AI练习了交流，还初步体验了一把做游戏策划的爽感。</p>
      <p>在学校的平台上，可以搜索到多款王怡萱出品的小游戏。在她推出“古文消消乐”之后，孩子们背诵古诗巩固古文基础，就基本不需要老师再费神去盯了，每一个人都想要挑战成为“AI boss”，非常积极。最高难度boss名叫“老夫子”，后来学生们觉得它的水平也不够看，又让王怡萱加上了更难的关卡挑战。新的boss直接用班上语文最棒的同学名字来命名——李子澄：元婴老怪。简介：恐怖如斯！唯快不破，瞬息之间！</p>
      <p>为了不断精进，包括王怡萱在内的39个老师，建立了一个“今天搓了吗”的AI分享群，大家把自己新鲜出炉的作品发在群里，互相学习讨教。云谷教育科技的AI产品技术专家刘青杰也被拉进了群，实时解答老师们遇到的问题。</p>
      <figure class="my-8"><img src="https://res.mojalab.cn/images/news/11/05-programming-class.jpg" alt="新闻图片 5" class="object-cover rounded-lg w-full h-full">
      <figcaption class="mt-2 text-sm text-gray-500">代立晨（右一）负责的高中编程课。邓睿涵（左四）是课上的积极分子。</figcaption>
      </figure>
      <p>“一大波AI来了，导致大家有点焦虑。老师们在一线教学，特别忙，没有很多时间去琢磨和掌握这些AI工具。为了给他们提供更多支持，我们会经常和老师们碰头、讨论。”刘青杰告诉《中国慈善家》，“一方面，我们需要弄明白，怎么能把这些AI工具链接到教学里，让老师们丝滑地用起来；另一方面，也要倾听老师们的想法，要把他们教育的理念和创想通过AI落地、实现。”</p>
      <p>2022年，云谷决定将原有的信息技术、设计思维两门课程，合并更新为DTI（Design Thinking and Technology Innovation，设计与技术创新）”课，作为了解技术、拥抱技术的兜底必修课，面向小学三年级至初中二年级的学生开放。通过DTI课，学生学习计算机的基础知识，掌握基础编程能力，养成计算思维和设计思维。2023年9月，为了迎接ChatGPT3.5所预示的技术革命浪潮，云谷再次对课程体系做出修改，加入了“AI创未来”这门选修课，更集中地对AI这门工具进行学习和探讨。</p>
      <p>“早期的技术课一直有一个困局：孩子们对一些基础概念已经理解不错了，但他们做的大部分都是桌面模型，很难在真实的场景里让用户使用。”DTI课程主创老师之一陈慧告诉《中国慈善家》，“所以我们选修课，是希望推动他们再走一步，借助AI去解决一些真实的问题。”</p>
      <p>两门技术相关的课程，CL课体系中的工程技术课，以及融在各类课程中的信息检索、信息洞察、技术应用的点与线，共同构成了云谷学校的科技素养教育网络。在这样的土地里，小学部的孩子们，已经开始用AI做自己的游戏了。</p>
      <p>三年级一班的小姑娘包恩熹，用AI开发了小程序——“这个字形怎么写”，用户按住手势，使用语音即可提问，省去必须翻字典的步骤。小程序会显示你所问的字形，动态讲授笔画顺序，还会给它组词。包恩熹在学习中发现，很多复杂的字形自己还没掌握，写起作业来时常停顿，就想出了这个方法。</p>
      <p>小学部的孩子们，有的用AI把数学题变得很奇怪，有的则非常关注，基于AI大模型来搭建平台，开放给用户标记藻华位置，记录质量变化。新科技，他们一点都没有面对。</p>
      <h2>回到人本身</h2>
      <p>云谷科创副校长卢晓飞告诉《中国慈善家》，云谷自己开发产品、研究AI，是学校的教育理念决定的。</p>
      <p>“科技对于云谷而言不是一个特色或者一个亮点，不是可有可无，而是一个需求刚性。”卢晓飞说。不过他也强调，虽然科技很重要，但在育人这个课题里，科技不是教育的核心。</p>
      <p>在云谷的官网上，有校名的内涵：“云，形容词为盛、多、崇高，谷，作为形容词为良善，动词为生养。取‘云谷’之名，希望独立、正义和崇高在这里能够培育和产生。”</p>
      <p>在校门处，一行字极其显眼：“让每一位孩子成为最好的自己。”</p>
      <figure class="my-8"><img src="https://res.mojalab.cn/images/news/11/06-school-team.jpg" alt="新闻图片 6" class="object-cover rounded-lg w-full h-full">
      <figcaption class="mt-2 text-sm text-gray-500">云谷学校各科都有校队，图为工程技术与计算机初中校队在做展示。</figcaption>
      </figure>
      <p>走进云谷，会立刻被学校的硬件吸引——教室的走廊和阳台都经过加宽加长，教室也设计成为“弹簧教室”，其与走廊之间的视野、与阳台之间的大门可以全部缩进墙内，展开形成一个整体的大型空间。课间15分钟里，学生不用下楼拥有宽敞的运动场地，孩子们甚至在阳台上踢着足球。</p>
      <p>“软件”方面，云谷也做出了积极的尝试。在符合国家任务教育课程标的基础上，云谷的课程设置和教学方法即为特色，以课程选择多、课程分层培养体系丰富，围绕孩子们不同的特长、民族，每个孩子都有自己的专长属课表；二来教学方法创新，教师不再是在讲台上滔滔不绝地“灌输”，学习更多以项目制、跨学科的方式开展。这里的学生们，也拥有一套不以成绩论英雄的评价体系。学校放弃了排名，而是以素养来为学生画像。</p>
      <p>以上这些尝试，可以看出云谷并不构成简单、功利的教育模式，而支撑教育前沿探索，需要投入巨大的资金和人力成本，因此，遂于普惠的公立学校，云谷的“教育田野”目前能覆盖的范围还比较有限。这注定了云谷学校难以在短期内被复制。进行持续的、高质量的教育探索，马云与阿里众人投入了巨额资金，来喂养这所类似于“吞金兽”一样的学校，一二期的学校总投资达到22亿元。马云曾钉斩铁地表示，“云谷从第一天起就是亏钱的，未来也不想挣钱。云谷要为中国的教育带来想象力”。</p>
      <p>这样一来，一所在应试教育模式之外另一种引流渠的学校面临，的挑战引人注目。中学部校长龚姚东坦言，这一代孩子基本是在优渥的生活中长大的，不愁吃穿，但也带来了一些问题，那就是不够接地气，因此云谷更希望在课程中放大“真实场景”，让孩子们解决“比如学校的艺术课，除了国画临摹或者西方艺术鉴赏，还要重点做社会设计类的东西。想要对这个社会有帮助，首先要进入社会的基本面他们，比如去骑手们生活的城中村，去工厂里一线的工人，的生活和社区环境是怎样的。”</p>
      <p>但在云谷成长的孩子们，有许多令人欣慰的地方。龚校长发现，他自己时常参加野外徒步，团队里什么扁平化的人都有，唯独缺了13-18岁的孩子。“这个中午的学生，已经要在户外消失了，大部分都集中在培训班里面。如果说云谷的孩子有哪方面最值得庆幸的，可能就是心理健康。”</p>
      <figure class="my-8"><img src="https://res.mojalab.cn/images/news/11/07-kindergarten.jpg" alt="新闻图片 7" class="object-cover rounded-lg w-full h-full">
      <figcaption class="mt-2 text-sm text-gray-500">云谷幼儿园老师带着孩子们的海报，主张亲近自然、保护环境，远足不留痕迹。｜龚怡洁</figcaption>
      </figure>
      <p>在云谷，有一个“自主性”的设置。根据成绩及素养评价、作业作业准时度、宿舍及公共学习区表现等指标，学生可获取0-3级的自主性权限。零至二级的学生，在晚上的不同时间前需要恢复电子设备，并且需要遵循相应的自习课规则。三级的学生，可以完全自由地使用电子产品，也可以自行安排自习与“留白”，对自己的时间与行动规划获得更大的主动权。</p>
      <p>邓睿涵是自主性三级的学生。其他人上课的时候，他常会出现在计算机实验室，磨磨自己的研究。他告诉《中国慈善家》，周围有同学非常偏科，常常苦于拉平各科成绩。“如果能有办法给这些学生更大的空间，会在专业项目上做得更好。”</p>
      <p>在龚姚东看来，学校的自主性等级设置是一种教育，它关系到如何看待电脑权力。“自主性搞不好，在学生眼里很可能会变成特权主义。自主性等级高的孩子，可以带着满学校跑。我们希望‘特权’可以发展成他的责任。给你自主性，是希望让你在其他人面前，成为一个更好的榜样。”</p>
      <p>作为一所具有先锋意义的创新学校，云谷未来必须经受考验，既要创新，又要回应现实社会的种种问题。当AI大潮涌来，其对于教育的变革性影响已经显现，总有人去对未来的教育进行探索和创新。</p>
      <p>云谷拥抱AI，成为AI时代教育领域第一个吃螃蟹的人。</p>
      <p>作者：龚怡洁</p>
      <p>图片来源：云谷学校</p>
      <p>图片编辑：张旭</p>
      <p>值班编辑：张旭</p>
