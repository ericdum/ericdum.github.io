...
const news: NewsItem[] = [
  {
    ...
    thumbnail: "/images/news/5/thumb.jpg",
    fullContent: `
  ...
  },
  {
    ...
    thumbnail: "/images/news/4/cover.png",
    fullContent: `
      <div class="article-content">
  ...
  },
  {
    ...
    thumbnail: "/images/news/10/cover.jpeg",
    fullContent: `
      <div class="article-content">
        <p>大家好，我是莎莫。</p>
        ...
        <img src="/images/news/10/cover.jpeg" alt="云谷学校" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/10/design.gif" alt="设计作品" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/10/design_week.jpeg" alt="设计周分享" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/10/factory1.jpeg" alt="工厂参观1" class="object-cover rounded-lg w-full h-full my-8">
        <p>去智能化工厂深度研学↓</p>
        <img src="/images/news/10/factory2.jpeg" alt="工厂参观2" class="object-cover rounded-lg w-full h-full my-8">
        <p>与隔壁的西湖大学和阿里达摩院研讨↓</p>
        <img src="/images/news/10/factory3.jpeg" alt="工厂参观3" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/10/ability_gap.jpeg" alt="能力鸿沟" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/10/susan.jpeg" alt="Susan老师" class="object-cover rounded-lg w-full h-full my-8">
        <p>■Susan老师</p>
        <p>说个简单的故事，可能你就理解了。</p>
        ...
        <img src="/images/news/10/cambridge.jpeg" alt="剑桥大学招生官来访" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <p>下滑查看云谷学生的专业录取 👇</p>
        <p>每个人都找到自己的心之所向。</p>
        <img src="/images/news/10/students1.jpeg" alt="学生录取1" class="object-cover rounded-lg w-full h-full my-8">
        <img src="/images/news/10/students2.jpeg" alt="学生录取2" class="object-cover rounded-lg w-full h-full my-8">
        <img src="/images/news/10/students3.jpeg" alt="学生录取3" class="object-cover rounded-lg w-full h-full my-8">
        <img src="/images/news/10/students4.jpeg" alt="学生录取4" class="object-cover rounded-lg w-full h-full my-8">
        <p>这不是随便说说，而是被检验过的。</p>
        ...
        <img src="/images/news/10/interns.jpeg" alt="回母校实习的孩子们" class="object-cover rounded-lg w-full h-full my-8">
        <p>■回母校实习的孩子们</p>
        ...
        <p>深度感受走在前沿不一样的教育</p>
        <p>去不了现场的也可以加老师咨询</p>
        <img src="/images/news/10/qrcode1.jpeg" alt="二维码1" class="object-cover rounded-lg w-full h-full my-8">
        <img src="/images/news/10/qrcode2.jpeg" alt="二维码2" class="object-cover rounded-lg w-full h-full my-8">
  ...
  },
  {
    ...
    thumbnail: "/images/news/9/640.webp",
    fullContent: `
      <div class="article-content">
  ...
  },
  {
    ...
    thumbnail: "/images/news/6/955.jpg",
    fullContent: `
      <div class="article-content">
        ...
        <img src="/images/news/6/955.jpg" alt="新闻图片1" class="object-cover rounded-lg w-full h-full my-8">
        <p>在这个科技飞速发展的时代，教育的变革与创新从未如此紧迫。而AIGC（生成式人工智能）技术的崛起，就如同划破黑夜的一道曙光，为科学教育带来了前所未有的机遇与挑战。</p>
        <img src="/images/news/6/958.jpg" alt="新闻图片2" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/6/960.jpg" alt="新闻图片3" class="object-cover rounded-lg w-full h-full my-8">
        <p>高校、中学、企业</p>
        ...
        <img src="/images/news/6/962.jpg" alt="新闻图片4" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/6/965.jpg" alt="新闻图片5" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/6/967.jpg" alt="新闻图片6" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/6/969.jpg" alt="新闻图片7" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/6/970.jpg" alt="新闻图片8" class="object-cover rounded-lg w-full h-full my-8">
        <p>科学沙龙碰撞思维火花</p>
        <p>探寻AIGC+教育的多种可能性</p>
        ...
        <img src="/images/news/6/971.jpg" alt="新闻图片9" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/6/975.jpg" alt="新闻图片10" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/6/977.jpg" alt="新闻图片11" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/6/978.jpg" alt="新闻图片12" class="object-cover rounded-lg w-full h-full my-8">
  ...
  },
  {
    ...
    thumbnail: "/images/news/3/image-1.jpg",
    fullContent: `
      <div class="article-content">
        ...
        <img src="/images/news/3/image-1.jpg" alt="新闻图片 1" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/3/image-2.jpg" alt="新闻图片 2" class="object-cover rounded-lg w-full h-full my-8">
        <p>曹林和代立晨，都是软件工程师。一个偶然的机会，他俩作为志愿者，通过线上授课的方式，给普安县铅矿学校的孩子们，上了两堂有关太空和航天知识的视频科普课，很受孩子们的欢迎。而课堂上孩子们的一个提问，让两个程序员动了心思。</p>
        <img src="/images/news/3/image-3.jpg" alt="新闻图片 3" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/3/image-4.jpg" alt="新闻图片 4" class="object-cover rounded-lg w-full h-full my-8">
        <p>于是，曹林通过网上的火箭爱好者群或论坛，找到了还在深圳高校读书的火箭爱好者余畅一起加盟。三个小伙子通过网络沟通、分工，利用业余时间每天干到凌晨。十几天过后，终于拿出了一份很"亲近"小朋友的透明火箭设计方案。</p>
        <img src="/images/news/3/image-5.jpg" alt="新闻图片 5" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/3/image-6.jpg" alt="新闻图片 6" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/3/image-7.jpg" alt="新闻图片 7" class="object-cover rounded-lg w-full h-full my-8">
        <p>最终，在铅矿学校校长、老师的帮助下，发射场地选在了大山深处一个闲置的养鸡场里，确保安全。紧接着，在一间简陋的民房里，小伙伴们就着一盆柴火、一张木桌，开始火箭组装。而伴随着组装工作进行的，也有大家不断的争论。</p>
        <img src="/images/news/3/image-8.jpg" alt="新闻图片 8" class="object-cover rounded-lg w-full h-full my-8">
        <p>所有的争论，都是为了更好地接近目标。经过一昼夜努力，火箭组装完毕。第二天，为了给孩子们科普知识，找找发射火箭的感觉。大家带着四枚微型火箭来到学校，一边给孩子们讲课，一边让孩子们亲手发射火箭。</p>
        <img src="/images/news/3/image-9.jpg" alt="新闻图片 9" class="object-cover rounded-lg w-full h-full my-8">
        <p>第三天，普安气象良好，大伙儿在发射场都很兴奋。泥巴水塘旁，空心砖一坐，曹林和余畅开始组装发射架。而由于前一天空气湿度大，放在露天的电动组装工具受潮罢工，大家只得手动拧螺栓，导致组装进度严重滞后。同时，曹林偏胖的身体也出现了状况。</p>
        <img src="/images/news/3/image-10.jpg" alt="新闻图片 10" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/3/image-11.jpg" alt="新闻图片 11" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/3/image-12.jpg" alt="新闻图片 12" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/3/image-13.jpg" alt="新闻图片 13" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/3/image-14.jpg" alt="新闻图片 14" class="object-cover rounded-lg w-full h-full my-8">
    ...
    `,
    videoUrl: "/images/news/3/video.mp4"
  },
  {
    id: 5,
    title: {
  ...
  },
  {
    ...
    author: "阿里巴巴公益",
    sourceUrl: "https://mp.weixin.qq.com/s?__biz=MzU2MzAxODI0Nw==&mid=2247567386&idx=1&sn=3ae23b2581765efcf8e3fc3f87933310",
    thumbnail: "/images/news/7/bracelet.png",
    fullContent: `
      <div class="article-content">
        <p>国务院在2017年公布的《\"十三五\"国家老龄事业发展和养老体系建设规划》中指出：\"预计到2020年（也就是明年），全国60岁以上老年人口将增加到2.55亿人左右，独居和空巢老年人将增加到1.18亿人左右。\"</p>
        <img src="/images/news/7/cover.png" alt="新闻图片1" class="object-cover rounded-lg w-full h-full my-8">
        <p>在这样的形势下，远在异乡的儿女们，如何照顾家里的老人成为了一个逃不开的话题。</p>
        <p>你们还记得去年那个为视障人士爆改一间房的代立晨（木酱）吗？</p>
        <img src="/images/news/7/previous_project.png" alt="新闻图片2" class="object-cover rounded-lg w-full h-full my-8">
        <p>今年他又出来搞事情了，这次他的目标是老年人。</p>
        <img src="/images/news/7/new_project.png" alt="新闻图片3" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/7/grandparents.png" alt="新闻图片4" class="object-cover rounded-lg w-full h-full my-8">
        <p>爷爷年轻的时候参与了南京长江大桥的建设。</p>
        <p>像那个年代走过来的很多人一样，爷爷几乎将一生都献给了祖国的桥梁事业，一年也回不了几次家。</p>
        <img src="/images/news/7/bridge.png" alt="新闻图片5" class="object-cover rounded-lg w-full h-full my-8">
        <p>奶奶就坚持三四天给爷爷写一封信，这一写就是17年，2000多封信。</p>
        <p>终于等到了爷爷退休，突如其来的疾病却夺走了他的记忆。</p>
        <p>在这儿孙满堂之时，爷爷却叫不出他们的名字。</p>
        <img src="/images/news/7/letters.png" alt="新闻图片6" class="object-cover rounded-lg w-full h-full my-8">
        <p>全球每3秒钟，就有1个人患上阿尔兹海默症，这种疾病最残忍的是——不可逆转。</p>
        <p>从爷爷患病以后，奶奶坚持亲自护理，寸步不离。</p>
        <p>因为一旦离开，爷爷就有可能走丢。</p>
        <p>有一次爷爷自顾自地推门出去，家人找了8个小时才把他找回来，问他为什么出去。他说\"我要找我老婆，曹雪梅\"。</p>
        <img src="/images/news/7/care.png" alt="新闻图片7" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/7/sensors.png" alt="新闻图片8" class="object-cover rounded-lg w-full h-full my-8">
        <p>爷爷佩戴了一个手环，这个手环会监测爷爷的一些身体指数，再加上刚刚说的人体传感器给出的睡眠质量数据，睡觉和起床的时间等等， 系统会给一个综合的评分。如果今天给出的评分偏低了，那就要格外的关注一下爷爷的身体了。</p>
        <img src="/images/news/7/bracelet.png" alt="新闻图片9" class="object-cover rounded-lg w-full h-full my-8">
        <p>手环更大的功能是可以实时检测爷爷的定位，如果爷爷以后再走丢可以通过地图定位找到他，还能一键呼叫爷爷，爷爷也可以一键报警。</p>
        <img src="/images/news/7/location.png" alt="新闻图片10" class="object-cover rounded-lg w-full h-full my-8">
        <p>手机软件还中有爷爷家温度湿度的数据，孙女贝贝可以实时监测到老人家里的环境， 如果爷爷奶奶家温度过低， 也会预警到贝贝手机，还有开启空调的按钮，可以远程一键给他们开启空调。</p>
        <img src="/images/news/7/temperature.png" alt="新闻图片11" class="object-cover rounded-lg w-full h-full my-8">
        <p>智能药箱是另一个惊喜，贝贝可以在系统里设置爷爷每天需要吃药的时间。比如爷爷每天晚上八点钟要吃药打针，八点十分，药箱还没有打开，那么贝贝手机端就会弹出一个提示，进入页面之后有个一键通话的功能，可以直接给奶奶打过去电话，提醒她给爷爷吃药。</p>
        <img src="/images/news/7/medicine.png" alt="新闻图片12" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <img src="/images/news/7/fridge.png" alt="新闻图片13" class="object-cover rounded-lg w-full h-full my-8">
        <p>智能画框，是为爷爷量身定做的。因为爷爷的短期记忆的原因，儿女们可以把随时拍的视频和照片一键传运到爷爷奶奶的相框里，爷爷能每天都看到他们，或许就能够唤醒一些他的记忆。</p>
        <img src="/images/news/7/frame.png" alt="新闻图片14" class="object-cover rounded-lg w-full h-full my-8">
        <p>奶奶的儿子在广州工作，只要对着说一声\"给儿子打电话\"，就会自动呼出视频电话。</p>
        <img src="/images/news/7/video_call.png" alt="新闻图片15" class="object-cover rounded-lg w-full h-full my-8">
        <p>这样的设计不仅让不能守候在老人身边的儿女通过科技实时关注父母的健康状况。还能为社区和养老机构提供更高效的集中看护方案。</p>
        <img src="/images/news/7/solution.png" alt="新闻图片16" class="object-cover rounded-lg w-full h-full my-8">
  ...
  },
  {
    ...
    author: "阿里云",
    sourceUrl: "https://mp.weixin.qq.com/s?__biz=MzU2MzAxODI0Nw==&mid=2247567386&idx=1&sn=3ae23b2581765efcf8e3fc3f87933310",
    thumbnail: "/images/news/8/sensors.png",
    fullContent: `
      <div class="article-content">
        <p>房子如何既会听，又会看？</p>
        <p>最近央视《秘密大改造》播放了一期特殊节目：为一位视障人士进行家居改造。阿里云IoT工程师代立晨接受了这项极具挑战的项目。</p>
        <img src="/images/news/8/cover.gif" alt="新闻图片1" class="object-cover rounded-lg w-full h-full my-8">
        ...
        <p>灯带起到了为视障人士指路的作用。</p>
        <img src="/images/news/8/light_guide.gif" alt="新闻图片2" class="object-cover rounded-lg w-full h-full my-8">
        <p>移步到客厅，不得不说说这个小编最喜欢的窗帘。只要当室外温度达到事先设置好的临界温度，窗帘就会自动合起，太阳下山前窗帘又会自动拉开。</p>
        <img src="/images/news/8/curtain.gif" alt="新闻图片3" class="object-cover rounded-lg w-full h-full my-8">
        <p>洗手间的灯光也会根据主人的进出自动打开、熄灭。</p>
        <img src="/images/news/8/bathroom_light.gif" alt="新闻图片4" class="object-cover rounded-lg w-full h-full my-8">
        <p>当主人走出洗手间，灯光会自动熄灭，马桶也会自动感应冲水。</p>
        <img src="/images/news/8/toilet.gif" alt="新闻图片5" class="object-cover rounded-lg w-full h-full my-8">
        <p>不过你一定要问，这么多声控设备，万一自己的声音或者声控设备出了问题怎么办？</p>
        <p>这个问题，设计者早已经想好。房间内所有的电器都可以用包括物理按键、声音控制、手机APP控制三种方式去控制。</p>
        <img src="/images/news/8/control.gif" alt="新闻图片6" class="object-cover rounded-lg w-full h-full my-8">
        <p>在60余平米的房子中，代立晨主要还是通过大量的传感设备、网络设置、传输指令实现对设备的统一控制。</p>
        <img src="/images/news/8/sensors.png" alt="新闻图片7" class="object-cover rounded-lg w-full h-full my-8">
        <p>桌上摆着的一堆零件，有的是人体感应器，有的是红外信号发射器，有的是识别声音指令的，就是为了让家里的电器能够随时响应主人的需求。</p>
        <img src="/images/news/8/parts.png" alt="新闻图片8" class="object-cover rounded-lg w-full h-full my-8">
